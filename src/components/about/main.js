...
const main = () => {
    return (
<div className="min-h-screen bg-[#C3F2E5] bg-hero-pattern bg-cover bg-blend-lighten">    <main className="max-w-4xl mx-auto px-4 py-12 ">
      <div className="text-center space-y-8">
        <div className="space-y-2">
          <p className="text-sm uppercase tracking-wider">ABOUT US</p>
        ...
        <h1 class="text-4xl font-medium text-gray-800 ">
          ...
          <span className="text-emerald-600"> is your valuable partner for</span>
          <br />
          <span>Campus </span>
          <span className="text-emerald-600">Placements </span>
          <span>Training.</span>
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16">
          <div className="space-y-4">
            <h2 className="text-4xl font-large  text-gray-800">Mission</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-4xl font-large text-gray-800">Vision</h2>
            <p className="text-gray-600 leading-relaxed">
